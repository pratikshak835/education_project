...
void main() {
  ...
  group('cacheFirstTimer', () {
    ...
    test(
        'should throw a [CacheException] when there is an error catching the data ',
        () async {
  ...
  group('checkIfUserIsFirstTime', () {
    test(
      ...
      'return  the right response from the storage when data exists',
      () async {
  ...
  test(
    'should throw a [CacheException] when there is an '
